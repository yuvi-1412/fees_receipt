...
if ($mysqli->connect_error) {
	...
	$mysqli->connect_error);
        ...
        if($mode==1) { //insert
            ...
            $query = ("update students_excel set
            year_term_code='$Year_term_code', course_code='$Course_code', branch_code='$Branch_code',
            acad_fee='$Academic_Fees',  dev_fee='$Development_Fees', univ_fee='$University_Fees', caution_money='$Caution_Money',
            univ_enroll_fee='$University_Enrollment_Fees',  exam_fee='$Exam_Fees', excess_fee='$Excess_Amount', late_fee='$Late_Fees',
            reg_fee='$Registration_Fees',  misc_fee='$Miscellaneous_Fees', total_fee='$Total_Fees', paid_status='$Payment_status',
            utr_upi_neft_DD_number='$DD',  via_bank_name_paytm_phonepay_googlepay_etc='$BANK', payment_date='$Payment_Date'
             where Enroll_no='$Enrollment'");
        }
